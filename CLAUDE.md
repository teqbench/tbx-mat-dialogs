...
- `npm run storybook` / `npm run storybook:dev` — Start [Storybook ↗](https://storybook.js.org) dev mode (port 6006, loads `src/components/**/*.stories.ts`)
- `npm run storybook:docs` — Start [Storybook ↗](https://storybook.js.org) docs mode (port 6007, loads `src/stories/**/*.stories.ts`)
- `npm run build-storybook` / `npm run build-storybook:dev` — Build dev-mode static [Storybook ↗](https://storybook.js.org) (`storybook-dev-static/`)
- `npm run build-storybook:docs` — Build docs-mode static [Storybook ↗](https://storybook.js.org) (`storybook-docs-static/`)
...
- **Private repository:** Email link (`[info@teqbench.dev](mailto:info@teqbench.dev)`). [GitHub ↗](https://github.com) Private vulnerability reporting is not available without [GitHub Advanced Security ↗](https://github.com/security/advanced-security).
