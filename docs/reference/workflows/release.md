...
1. Creates a [GitHub Release ↗](https://docs.github.com/en/repositories/releasing-projects-on-github) with auto-generated release notes.
2. Creates a [git ↗](https://git-scm.com) tag (e.g., `v0.1.1`).
...
```json
{
    ...
    "packages": {
        ".": {
            "package-name": "@teqbench/tbx-mat-dialogs",
